    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-gray-50 rounded-2xl p-8 text-center border border-gray-100">
        ...
        <button 
          ...
          className="w-full bg-[#25D366] text-white py-4 rounded-full font-bold hover:bg-[#128C7E] transition-all shadow-lg hover:shadow-xl active:scale-95 mb-4 flex items-center justify-center gap-2"
        >
