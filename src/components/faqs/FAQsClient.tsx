                ...
                <nav className="space-y-2">
                  {categories.map((category, index) => (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all ${activeCategory === index
                          ? 'bg-black text-white'
                ...
                {categories[activeCategory].faqs.map((faq, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        className={`shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all ${openFAQ === index ? 'bg-black text-white' : 'bg-gray-100 text-gray-600'
                          }`}
                      >
                        <svg
