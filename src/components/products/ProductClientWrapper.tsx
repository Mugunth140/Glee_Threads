...
export default function ProductClientWrapper({ product }: ProductClientWrapperProps) {
    const [selectedSize, setSelectedSize] = useState<string | null>(product.sizes?.[0]?.size_name || null);
                                    ...
                                    product.sizes.map((size) => {
                                        return (
                                            <button
                                                ...
                                                className={`min-w-14 px-5 py-3 rounded-full text-sm font-medium transition-all ${selectedSize === size.size_name
