        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2 mb-6">
              ...
              <p className="text-sm text-gray-500">
                <span className="font-medium text-black">Phone:</span> <a href="tel:+918248333655" className="hover:text-primary transition-colors">+91 8248333655</a>
              </p>
            </div>
            {/* Social Links */}
            <div className="flex gap-3">
              <a href="https://instagram.com/glee_threads" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-gray-100 rounded-full text-black hover:bg-primary hover:text-white transition-all">
              ...
              <a href="https://wa.me/918248333655" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-gray-100 rounded-full text-black hover:bg-primary hover:text-white transition-all">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/products?filter=graphic" className="text-sm text-gray-500 hover:text-primary transition-colors">
                  Graphic Tees
                </Link>
              </li>
              <li>
                <Link href="/products?filter=plain" className="text-sm text-gray-500 hover:text-primary transition-colors">
                  Plain Tees
                </Link>
              </li>
              <li>
                <Link href="/products?filter=oversized" className="text-sm text-gray-500 hover:text-primary transition-colors">
                  Oversized
                </Link>
              </li>
              <li>
                <Link href="/customize" className="text-sm text-gray-500 hover:text-primary transition-colors">
                  Custom Design
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/size-guide" className="text-sm text-gray-500 hover:text-primary transition-colors">
                  Size Guide
                </Link>
              </li>
            </ul>
